...
osSelect.addEventListener('change', updatePrice); // Pastikan OS juga ada di HTML
...
form.addEventListener('submit', (e) => {
    ...
    const vpsUsername = vpsUsernameInput.value;
    const vpsPassword = vpsPasswordInput.value;
    ...
    if (!vpsUsername || !vpsPassword || !userEmail) {
        showModal("Peringatan!", "Semua data harus diisi!");
        return;
    }
    ...
    showModal("Pesanan Dibuat!", "Pesanan Anda telah berhasil dibuat. Silakan lanjutkan ke halaman konfirmasi pembayaran.", () => {
